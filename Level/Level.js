  ...
  constructor(...args) {
    ...
    this.costumes = [
      ...
      new Costume("geometry-04", "./Level/costumes/geometry-04.svg", {
        x: 14.618037977499796,
        y: 2.2360659549995887
      }),
      ...
      new Costume("blkFull10", "./Level/costumes/blkFull10.svg", {
        x: 12.537599999999998,
        y: -1.1580999999999904
      }),
      ...
      new Costume("geometry-51", "./Level/costumes/geometry-51.svg", {
        x: 13.5,
        y: -5
      }),
      ...
      new Costume("geometry-64", "./Level/costumes/geometry-64.svg", {
        x: 3.1292060788176173,
        y: -12.587889814266902
      }),
