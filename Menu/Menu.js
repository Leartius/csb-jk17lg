...
export default class Menu extends Sprite {
  constructor(...args) {
    ...
    this.costumes = [
      new Costume("splash", "./Menu/costumes/splash.svg", { x: 240, y: 180 }),
      new Costume("text", "./Menu/costumes/text.svg", {
        x: -40.958987500000035,
        y: 6.339602499999984
      }),
      new Costume("border", "./Menu/costumes/border.svg", {
        x: 241.99999887500002,
        y: 180
      }),
      new Costume("level1", "./Menu/costumes/level1.svg", {
        x: 960,
        y: 183.00300300300307
      }),
