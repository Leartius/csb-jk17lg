...
export default class Player extends Sprite {
  constructor(...args) {
    ...
    this.costumes = [
      new Costume("geometry-01", "./Player/costumes/geometry-01.svg", {
        x: 18.933866666666717,
        y: 18.93386666666666
      }),
      new Costume("cubeFly", "./Player/costumes/cubeFly.svg", {
        x: 59.12500166666669,
        y: 27.351158955833284
      })
    ];
    ...
    this.vars.spike = 0;
    this.vars.frame = 35;
    this.vars.nextsecond = 44;
    this.vars.fps = 12;
    this.vars.jumppress = 0;
    this.vars.GetDirection = 79.89047730497133;
    this.vars.shakeY = 0.00005303461691719295;
    this.vars.coins = 0;
    this.vars.background = 3;
    this.vars.maxX = 23002;
    this.vars.overridelag = 0;
    this.vars.bounceidx = 1301;
    this.vars.levelsBy = "Leartius";
    this.vars.collect = [];
  }
