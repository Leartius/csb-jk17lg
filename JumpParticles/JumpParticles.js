...
export default class JumpParticles extends Sprite {
  constructor(...args) {
    ...
    this.vars.x11 = 641.3991692119998;
    this.vars.y10 = 10.405930236000001;
    this.vars.sx4 = -0.07510384849999996;
    this.vars.sy4 = 2.8007412795;
    this.vars.typ4 = 0;
    this.vars.siz3 = 0;
    this.vars.id = 8;
    this.vars.GetDirection2 = 157.28558764683277;
  }
